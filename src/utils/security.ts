/**
 * Synchronous SHA-256 implementation to securely hash the admin passcode.
 * This prevents plain-text passwords from being stored in localStorage or source files.
 */
